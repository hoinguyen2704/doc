package vn.group11.moviebooking.domain;
...
public class User {
    ...
    public String toString() {
        return "User [customer_id=" + customer_id + ", customer_name=" + customer_name + ", customer_email="
                + customer_email + ", customer_password=" + customer_password + ", customer_phone=" + customer_phone
                + ", customer_date_of_birth=" + customer_date_of_birth + ", customer_gender=" + customer_gender
                + ", customer_created_at=" + customer_created_at + ", customer_is_active=" + customer_is_active + "]";
    }
