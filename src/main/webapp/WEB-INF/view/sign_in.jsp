			...
			<body>
				...
				<div class="container_signup_signin" id="container_signup_signin">
					<div class="form-container sign-up-container">
						<form:form name="sign-up-form" action="/" onsubmit="return signUpValidateForm()" modelAttribute = "SignUp">
					...
					<div class="form-container sign-in-container">
						<form:form method="post" name="sign-in-form" style="color: var(--theme-title);" action="/"
							...
							<form:input path="customer_password" name="sign-in-passwd" type="password" placeholder="Password" />
